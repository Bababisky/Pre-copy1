...
app.get("/student/sta/br", function (_req, res) {
...
app.post('/borrow-asset', async (req, res) => {
    ...
    try {
        ...
        // เพิ่มคำร้องในตาราง BorrowReq พร้อม Activity และ UsageType
        const sqlInsert = `
        INSERT INTO BorrowReq (AssetId, BorrowDate, ReturnDate, Status, Borrowname, Activity, UsageType, SubmitTime)
        VALUES (?, ?, ?, 'Pending', ?, ?, ?, NOW())
        `;
